    ...
    class ExportBonLivraison
    {
        ...
        private List<DocumentVente> GetBonLivraisonFromDataBase(StreamWriter writer, List<Alert_Mail.Classes.Custom.CustomMailRecapLines> recapLinesList_new, string statut)
        {
            ...
            try
            {
                ...
                {
                    /*
                    writer.WriteLine(DateTime.Now + " | GetBonLivraisonFromDataBase() : conn str 1 : " + connection.ConnectionString + "\n\nconnection Json: \n" + new Database.Database().JsonFormat(connection));
                    writer.Flush();
                    
                    writer.WriteLine(DateTime.Now + " | GetBonLivraisonFromDataBase() : connection Json: \n" + new Database.Database().JsonFormat(connection));
                    writer.Flush();
                    */

                    writer.WriteLine(DateTime.Now + " | GetBonLivraisonFromDataBase() : conn str : " + connection.ConnectionString);
                    writer.Flush();
                    ...
                    writer.WriteLine(DateTime.Now + " | GetBonLivraisonFromDataBase() : Numéro de Bon de Livraison trouvé : " + listDocumentVente.Count());
