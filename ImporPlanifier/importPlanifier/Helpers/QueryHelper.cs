...
namespace importPlanifier.Helpers
{
    ...
    public static class QueryHelper
    {
     ...
     "" + order.adresseLivraison + "," + client.N_CatCompta + ",'" + order.codeAcheteur + ";" + order.codeFournisseur + "','" + order.NumCommande + "',20,0,0)";
        ...
        public static string get_ForCorrect(string cmd)
        {
     ...
     "WHERE doc.AR_REF = art.AR_REF and doc.do_piece='" + codeCommande + "'";
        ...
        public static string getListDocumentVente(int type)
        {
            if (type == 67)
            {
     ...
     "WHERE doc.AR_REF = art.AR_REF and doc.do_piece='" + codeDocument + "'";
        ...
        public static string getCustomer(string do_tiers)
        {
        ...
        public static string updateDocumentdeVente(string do_piece)
        {
        ...
        public static string getNegativeStockOfAProduct(string reference)
        {
            ...
            return "SELECT SUM(DL_Qte) FROM BIJOU.dbo.F_DOCLIGNE WHERE (DO_Piece LIKE 'MS%' OR DO_Piece LIKE 'MT%' OR DO_Piece LIKE 'CA%' OR DO_Piece LIKE 'BL%' OR DO_Piece LIKE 'FA%') AND AR_Ref IN('" + reference + "') ";
        }
        ...
        public static string getPositiveStockOfAProduct(string reference)
        {
            ...
            return "SELECT SUM(DL_Qte) FROM BIJOU.dbo.F_DOCLIGNE WHERE (DO_Piece LIKE 'FFA%' OR DO_Piece LIKE 'ME%' OR DO_Piece LIKE 'FBL%' ) AND AR_Ref IN('" + reference + "') ";
        }
